...
<form:form method="post" modelAttribute="employee">
		<table>
			...
			<tr>
			 ...
			 <tr>
				<td>Contact 1</td>
				<td><form:input path="contactList[0].code" /></td>
				<td><form:input path="contactList[0].number" /></td>
			</tr>
			<tr>
				<td>Contact 2</td>
				<td><form:input path="contactList[1].code" /></td>
				<td><form:input path="contactList[1].number" /></td>
			</tr>
			<tr>
				<td>Course 1</td>
				<td><form:input path="courseList[0].courseId" /></td>
				<td><form:input path="courseList[0].courseName" /></td>
			</tr>
			<tr>
				<td>Course 2</td>
				<td><form:input path="courseList[1].courseId" /></td>
